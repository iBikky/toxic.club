...
public class EntityUtill
    ...
    public static boolean isntValid(Entity entity, double range) {
        return entity == null || EntityUtill.isDead(entity) || entity.equals(EntityUtill.mc.player) || entity instanceof EntityPlayer && Toxic.friendManager.isFriend(entity.getName()) || EntityUtill.mc.player.getDistanceSq(entity) > MathUtil.square(range);
    }
    ...
    public static Color getColor(Entity entity, int red, int green, int blue, int alpha, boolean colorFriends) {
        ...
        if (entity instanceof EntityPlayer && colorFriends && Toxic.friendManager.isFriend((EntityPlayer) entity)) {
    ...
    public static boolean isCrystalAtFeet(final EntityEnderCrystal crystal, final double range) {
        for (final EntityPlayer player : EntityUtill.mc.world.playerEntities) {
            ...
            if (Toxic.friendManager.isFriend(player)) {
                continue;
            }
