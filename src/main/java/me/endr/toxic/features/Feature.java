package me.endr.toxic.features;
...
import me.endr.toxic.manager.TextManager;
...
public class Feature
    ...
    public TextManager renderer = Toxic.textManager;
    private String name;
    ...
    public Setting register(Setting setting) {
        ...
        if (this instanceof Module && Feature.mc.currentScreen instanceof ToxicGui) {
            ToxicGui.getInstance().updateModule((Module) this);
        }
        return setting;
    }
