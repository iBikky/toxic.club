package me.endr.toxic.features.modules;
...
public class Module
    ...
    public void setDisplayName(String name) {
        Module module = Toxic.moduleManager.getModuleByDisplayName(name);
        Module originalModule = Toxic.moduleManager.getModuleByName(name);
