...
import me.endr.toxic.manager.ConfigManager;
...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        Module module = Toxic.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = Toxic.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
